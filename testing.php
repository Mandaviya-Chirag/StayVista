...
<!-- Mirrored from diamant.kwst.net/site/room-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Jul 2024 12:34:31 GMT -->
    ...
    <div id="main">
        ...
        <header class="main-header">
            <div class="container">
                ...
                <div class="header-top  fl-wrap">
                    <div class="header-top_contacts"><a href="#"><span>Call:</span> +489756412322</a><a
                            href="#"><span>Find us:</span> INDIA</a></div>
                ...
                <div class="nav-holder-wrap init-fix-header  fl-wrap">
                    ...
                    <div class="serach-header-btn_wrap">
                        <a href="rooms.html" class="serach-header-btn"><i class="fa-light fa-magnifying-glass"></i>
                            <span>Serach a Room</span></a>
                    </div>
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide hov_zoom">
                                        ...
                                        <a href="images/room/1.jpg" class="box-media-zoom   popup-image"><i
                                    ...
                                    <div class="swiper-slide  hov_zoom">
                                        ...
                                        <a href="images/room/2.jpg" class="box-media-zoom   popup-image"><i
                                                class="fal fa-search"></i></a>
                                    </div>
                                    <!-- swiper-slide end-->
                                    <!-- swiper-slide-->
                                    <div class="swiper-slide  hov_zoom">
                                        ...
                                        <a href="images/room/3.jpg" class="box-media-zoom   popup-image"><i
                                                class="fal fa-search"></i></a>
                                    </div>
                                    <!-- swiper-slide end-->
                                    <!-- swiper-slide-->
                                    <div class="swiper-slide  hov_zoom">
                                        ...
                                        <a href="images/room/5.jpg" class="box-media-zoom   popup-image"><i
                                                class="fal fa-search"></i></a>
                                    </div>
                                    <!-- swiper-slide end-->
                                    <!-- swiper-slide-->
                                    <div class="swiper-slide  hov_zoom">
                                        ...
                                        <a href="images/room/4.jpg" class="box-media-zoom   popup-image"><i
                                                class="fal fa-search"></i></a>
                                    </div>
                                    <!-- swiper-slide end-->
                                </div>
                            ...
                            <div class="dec-container">
                                ...
                                <div class="text-block">
                                    ...
                                    <div class="text-block-container">
                                        <p class="has-drop-cap">Qraesent eros turpis, commodo vel justo at, pulvinar
                                            mollis eros. Mauris aliquet eu quam id ornare. Morbi ac quam enim. Cras
                                            vitae nulla condimentum, semper dolor non, faucibus dolor. Vivamus
                                            adipiscing eros quis orci fringilla, sed pretium lectus viverra.
                                        ...
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar
                                            ...
                                            purus viverra. Interdum et malesu they adamale fames ac anteipsu pimsine
                                            faucibus curabitur arcu site feugiat in tortor in, volutpat sollicitudin
                                            libero. Hotel non lorem acer suscipit bibendum vulla facilisi nedeuter .</p>
                                        <p>Fames massa tortor sit nisl sit. Duis nulla tempus quisque et diam
                                            condimentum nisl. Rhoncus quisque elementum nulla lorem at turpis vitae
                                            quisque. Vulputate duis vel et odio hendrerit magna. Nec lacus dui egestas
                                            sit. Vulputate tincidunt viverra viverra etiam porta facilisis. Diam dui
                                            euismod eget donec. Pharetra leo sed felis urna. At a viverra urna elementum
                                            tristique ac integer pretium. Vel tincidunt sed mi nulla lectus sagittis.
                                        </p>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="meg_aminites_item"><i
                                                        class="fa-light fa-water-ladder"></i><span>Free Swimming
                                                        Pool</span></div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="meg_aminites_item"><i
                                                        class="fa-light fa-baby-carriage"></i><span>Extra Baby
                                                        Bed</span></div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="meg_aminites_item"><i
                                            ...
                                            <div class="col-lg-4">
                                                <div class="meg_aminites_item"><i
                                                        class="fa-light fa-wifi"></i><span>Free Wi Fi</span></div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="meg_aminites_item"><i
                                                        class="fa-light fa-air-conditioner"></i><span>Air
                                                        Conditioned</span></div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="meg_aminites_item"><i
                                                        class="fa-light fa-refrigerator"></i><span>In-room
                                    ...
                                    <form class="custom-form" action="https://diamant.kwst.net/" name="bookform">
                                        <fieldset>
                                            <div class="input-wrap">
                                                ...
                                                <input type="text" id="first_name" placeholder="Your Name *" value="">
                                            </div>
                                            <div class="input-wrap">
                                                <label>Last Name:</label>
                                                <input type="text" id="last_name" placeholder="Your Name *" value="">
                                            </div>
                                            <div class="input-wrap">
                                            ...
                                            <div class="input-wrap">
                                                ...
                                                <input type="text" id="phone" name="phone" value="Single" required>
                                            </div>
                                            <div class="input-wrap">
                                                <label for="rooms">Number of Rooms:</label>
                                                <input type="text" id="rooms" name="rooms" min="1" required>
                                            </div>
                                            ...
                                            <div class="quantity-item">
                                                ...
                                                <input type="text" name="quantity" title="Qty" class="qty color-bg" data-min="1" data-step="1" value="0">
                                            ...
                                            <div class="quantity input-wrap ">
                                                ...
                                                <div class="quantity-item">
                                                    <input type="button" value="-" class="minus">
                                                    <input type="text" name="quantity" title="Qty" class="qty color-bg" data-min="1" data-step="1" value="1">
                                                    <input type="button" value="+" class="plus">
                                                </div>
                                            </div>
        ...
        <footer class="main-footer">
                                ...
                                <div class="footer-widget">
                                    ...
                                    <div class="footer-widget-content">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                            ...
                                            inventore veritatis et quasi architecto. Consectetur adipiscing elit. </p>
                                        <a href="about.html" class="footer-widget-content-link"><span>Read
                                                more</span></a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <a href="index-2.html" class="footer-logo"><img src="images/logo.png" alt=""></a>
